...
# blockstrap ![Status: experimental](https://img.shields.io/badge/status-experimental-orange)
...
- `...`: passed to base [`sample()`](https://rdrr.io/r/base/sample.html)
  allowing e.g. [`set.seed()`](https://rdrr.io/r/base/Random.html)
  beforehand or other sampling tweaks.
